...
BEGIN
  PR_GENERATE('HIST_INSTR_ENTRY_DTL', V_HIST_ID, V_HIST_CODE);
   ...
   WHERE BATCH_GENERATED = '1'
     ...
     AND X.PROSPECT_ID =
         (SELECT l.PROSPECTID
           ...
           where l.PROSPECTcode in ('LBAN21000011818'));
     END;
     
     
     DELETE qc_lms.qt_instr_entry_dtl e
